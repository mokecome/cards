  ...
  useEffect(() => {
    if (!searchText.trim()) {
      ...
      const filtered = cards.filter(card => 
        ...
        (card.company_phone1 && card.company_phone1.includes(searchText)) ||
        (card.company_phone2 && card.company_phone2.includes(searchText)) ||
        ...
        <div className="contact-info" style={{ marginBottom: '12px' }}>
          ...
          {card.company_phone1 && (
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
              ...
              <span style={{ fontSize: '14px' }}>公司電話1: {card.company_phone1}</span>
            </div>
          )}
          {card.company_phone2 && (
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
              <PhoneFill style={{ color: '#1890ff', fontSize: '14px' }} />
              <span style={{ fontSize: '14px' }}>公司電話2: {card.company_phone2}</span>
            </div>
          )}
          {card.email && (
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
          ...
          {(card.company_address1 || card.company_address2) && (
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px', marginBottom: '4px' }}>
              ...
              <div style={{ fontSize: '14px', lineHeight: '1.4' }}>
                {card.company_address1}
                {card.company_address2 && <div>{card.company_address2}</div>}
              </div>
            </div>
          )}
        </div>
